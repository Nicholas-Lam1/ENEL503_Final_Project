...
for filename in os.listdir(image_directory):
    if filename.endswith((".jpg", ".png", ".jpeg", ".bmp")):  # Supported image formats
        ...
        params.maxArea = 10000  # Maximum area of a blob
        ...
        stretched_rgb = cv2.drawKeypoints(stretched_rgb, keypoints, None, (0, 0, 255), cv2.DRAW_MATCHES_FLAGS_DRAW_RICH_KEYPOINTS)
        ...
        image4_rgb = cv2.cvtColor(final_mask, cv2.COLOR_BGR2RGB)
